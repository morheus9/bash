...
sudo pacman -Rns foo - удалить пакет и зависимости
yay -Rns foo - удалить пакет и зависимости

sudo pacman -Qm - найти пакеты AUR
yay -Yc - найти ненужные зависимости
